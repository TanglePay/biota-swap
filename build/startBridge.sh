...
addr="0x"$addr
if [ $addr = "0xfb6e712F4f71D418A298EBe239889A2496f1359b" ];then
...
elif [ $addr = "0x3Fdd4B2d69848F74E44765e6AD423198bdBD94fa" ]; then
...
elif [ $addr = "0x380dF538Ab2587B11466d07ca5c671d33497d5Ca" ]; then
...
elif [ $addr = "0x5e80cf0C104D2D4f685A15deb65A319e95dd80dD" ]; then
...
elif [ $addr = "0x9dcb974Cf7522F91F2Add8303e7BCB2221063c48" ]; then
...
elif [ $addr = "0xeBbe638eF6dF4A3837435bB44527f8D9BA9CF981" ]; then
